# Generated by Django 3.2 on 2021-06-26 11:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contacto_telefónico', models.CharField(blank=True, max_length=17, validators=[django.core.validators.RegexValidator(message='Phone number must be entered in a valid format.', regex='^\\+?1?\\d{9,15}$')])),
                ('cidade', models.CharField(blank=True, max_length=155)),
                ('comentário', models.TextField(blank=True)),
